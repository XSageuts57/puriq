...
import { Search, MapPin, Star, Compass, Clock, Users, Calendar } from 'lucide-react';
...
export default function Tours() {
  ...
  const categories = [
    ...
    { id: 'gastronomico', label: 'Gastronómico', icon: '🍜' },
  ];

  const getDifficultyColor = (difficulty: string) => {
    if (difficulty === 'Fácil') return 'text-green-400 bg-green-400/10';
    if (difficulty === 'Moderado') return 'text-yellow-400 bg-yellow-400/10';
      ...
      <div className="max-w-7xl mx-auto px-5 pt-8">
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md rounded-full px-2 py-1 text-xs flex items-center gap-1">
                  ...
                  <span className="text-zinc-400">({tour.reviews})</span>
                </div>
              ...
              <div className="p-5">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-zinc-400">{tour.location}</span>
                </div>
                
                <h3 className="text-xl font-bold mb-2 line-clamp-1">{tour.title}</h3>
                <p className="text-zinc-400 text-sm mb-3 line-clamp-2">{tour.description}</p>
        ...
        {filteredTours.length === 0 && (
          <div className="text-center py-20">
            <p className="text-zinc-400">No se encontraron tours</p>
          </div>
        )}
        ...
        <div className="mt-12 mb-10">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-red-600/20 to-orange-600/20 border border-white/10 p-8">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-4">
              <div>
                <h3 className="text-2xl font-bold mb-2">¿Listo para la aventura?</h3>
                <p className="text-zinc-300">Reserva tu tour y vive una experiencia inolvidable</p>
              </div>
