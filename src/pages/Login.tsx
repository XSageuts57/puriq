...
import { Mail, Lock, User, Phone, CreditCard, Eye, EyeOff, ArrowRight, CheckCircle, Sparkles, Mountain, Hotel, Utensils } from 'lucide-react';
...
{/* Botón de Google - CORREGIDO con estilos más específicos */}
<button
  type="button"
  onClick={handleGoogleLogin}
  disabled={loading}
  className="w-full bg-white/10 hover:bg-white/20 border border-white/30 py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-3 cursor-pointer hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/10 relative z-20"
